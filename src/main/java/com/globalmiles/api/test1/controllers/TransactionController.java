...
public class TransactionController extends BaseController {    
     ...
     * @return The singleton instance of the TransactionController class 
     */
    ...
    public void createOrderInfoAsync(
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5252189887692127976L;
            {
                    put( "Accept", accept );
    ...
    public void createCartInfoAsync(
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5140118873804269377L;
            {
                    put( "Accept", accept );
                    put( "Content-Type", contentType );
                    put( "Authorization", authorization );
